    ...
    >
      <RevealOnScroll>
        <div className="flex flex-col md:flex-row md:items-center gap-10 z-10 px-4">
          ...
          <div className="flex-1">
            <h1 className="text-center text-5xl md:text-6xl font-bold pb-5 bg-gradient-to-r from-blue-500 to-cyan-600 bg-clip-text text-transparent leading-right">
              Hi, I'm Ryan Kim
            </h1>
            <p className="text-center text-neutral-900 dark:text-white text-lg mb-8 max-w-lg mx-auto">
